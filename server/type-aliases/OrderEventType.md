...
[@bates/squareup API Reference](../../README.md) / [server](../README.md) / OrderEventType

# Type Alias: OrderEventType

> **OrderEventType** = `"order.created"` \| `"order.updated"` \| `"order.fulfillment.updated"`

Defined in: [src/server/types.ts:14](https://github.com/mbates/squareup/blob/5cbceb7be75e480372e4059c7badcdbbc730e2e4/src/server/types.ts#L14)
