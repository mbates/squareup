...
[@bates/squareup API Reference](../../README.md) / [server](../README.md) / CustomerEventType

# Type Alias: CustomerEventType

> **CustomerEventType** = `"customer.created"` \| `"customer.updated"` \| `"customer.deleted"`

Defined in: [src/server/types.ts:20](https://github.com/mbates/squareup/blob/982da1d528d8eb74b8387f5a958673b817575922/src/server/types.ts#L20)
