...
[@bates/squareup API Reference](../../README.md) / [server](../README.md) / TeamEventType

# Type Alias: TeamEventType

> **TeamEventType** = `"team_member.created"` \| `"team_member.updated"`

Defined in: [src/server/types.ts:50](https://github.com/mbates/squareup/blob/982da1d528d8eb74b8387f5a958673b817575922/src/server/types.ts#L50)
