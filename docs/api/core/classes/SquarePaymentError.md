...
Defined in: [core/errors.ts:90](https://github.com/mbates/squareup/blob/main/src/core/errors.ts#L90)
...
Defined in: [core/errors.ts:93](https://github.com/mbates/squareup/blob/main/src/core/errors.ts#L93)
